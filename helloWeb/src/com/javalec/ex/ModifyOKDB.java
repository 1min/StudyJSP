...
/**
 * Servlet implementation class ModifyOKDB
 */
@WebServlet("/ModifyOKDB")
public class ModifyOKDB extends HttpServlet {
...
//			System.out.println(query);
			try {
				...
				if(i ==1 ){
					...
					response.sendRedirect("modifyResultDB.jsp");
				} else {
					System.out.println("update fail");
					response.sendRedirect("modifyDB.jsp");
				}
			} catch(Exception e) {
				e.printStackTrace();
			} finally {
